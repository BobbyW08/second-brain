...
export const Route = createFileRoute('/_authenticated/tables/$tableId/settings')({
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Configure the schema for "{tableSchema.name}"</p>
      </div>

      <TableSchemaBuilder
        tableId={tableId}
        userId={userId}
        initialColumns={(tableSchema.columns as import('@/queries/tables').TableColumn[]) ?? []}
      />
    </div>
  )
}
