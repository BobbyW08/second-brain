...
export const getSchedulingSuggestions = createServerFn({ method: 'POST' })
  .inputValidator(
    z.object({
      tasks: z.array(z.object({ id: z.string(), title: z.string(), priority: z.string(), block_size: z.string() })),
      existingBlocks: z.array(z.object({ start_time: z.string(), end_time: z.string(), title: z.string() })),
