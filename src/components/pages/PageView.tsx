	...
	return (
		<div className="flex-1 min-h-0 overflow-hidden w-full flex flex-col">
			<div className="flex-1 min-h-0 overflow-y-auto">
				<div className="mx-auto w-full max-w-[720px] px-8 py-12 flex flex-col min-h-full">
			...
			{/* AI Prompt Bar - pinned at bottom */}
			{userId && <AIPromptBar pageId={resolvedPageId} userId={userId} />}
		</div>
	);
}
