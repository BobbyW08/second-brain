...
import type { TableColumnType, TableColumn } from '@/queries/tables';
...
export function TableSchemaBuilder({ tableId, userId, initialColumns }: TableSchemaBuilderProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={saveChanges} disabled={isPending} className="flex items-center gap-2">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {columns.length === 0 ? (
              <p className="text-muted-foreground text-center py-4">No columns configured</p>
            ) : (
