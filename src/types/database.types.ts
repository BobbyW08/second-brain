  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["table_id"]
            isOneToOne: false
            referencedRelation: "tables_schema"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "table_rows_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      tables_schema: {
        ...
        Relationships: [
          {
            foreignKeyName: "tables_schema_folder_id_fkey"
            columns: ["folder_id"]
            isOneToOne: false
            referencedRelation: "folders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tables_schema_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
